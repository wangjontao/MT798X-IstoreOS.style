...
sed -i '7i src-git daed https://github.com/QiuSimons/luci-app-daed.git;master' feeds.conf.default
sed -i '8i src-git ssr-plus https://github.com/fw876/helloworld.git;master' feeds.conf.default
